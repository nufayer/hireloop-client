    ...
    if (status === 'complete') {
        ...
        if (planId && customerEmail) {
            try {
                ...
                console.error('Failed to create subscription after successful payment:', error);
                // We don't throw here to avoid 500, but we might want to show a warning
            }
        } else {
            console.warn('Skipping subscription creation because planId or customerEmail is missing.', { planId, customerEmail });
        }
